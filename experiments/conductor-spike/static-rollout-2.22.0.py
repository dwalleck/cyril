...
Path('experiments/conductor-spike/static-2.22.0/static-rollout-2.22.0.json').write_text(json.dumps(all_records, indent=2, sort_keys=True))
if len(all_records) == 2:
    ...
    Path('experiments/conductor-spike/static-2.22.0/static-rollout-delta.json').write_text(json.dumps(delta, indent=2, sort_keys=True))
