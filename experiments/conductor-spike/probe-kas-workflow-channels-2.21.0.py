#!/usr/bin/env python3
"""
Workflow inter-step DATA PASSING on kiro-cli 2.21.0 / KAS 0.54.8 (2.20.1 probe, renamed outputs; KAS_PIN=2.20.1 = 0.54.3 control).
...
TRACE = os.path.join(SCRATCH, f"kas-workflow-channels-{LEG}-2.21.0.jsonl")
...
verdict = {"leg": LEG, "style": STYLE, "bundle": PIN_VER or "0.54.8-live", "status": status,
...
with open(os.path.join(SCRATCH, f"kas-workflow-channels-{LEG}-2.21.0-verdict.json"), "w") as fh:
