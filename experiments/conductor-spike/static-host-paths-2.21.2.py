...
new = Path(sys.argv[2]) if len(sys.argv) > 2 else Path('/home/dwalleck/.local/share/kiro-research/binaries/2.21.2/extracted/kiro-cli-chat')
out = Path(sys.argv[3]) if len(sys.argv) > 3 else Path('experiments/conductor-spike/static-2.21.2/static-host-paths-delta.json')
