...
OUT = pathlib.Path(__file__).with_name("logs") / "probe-kas-subagent-2.7.1.log"
OUT.parent.mkdir(exist_ok=True)

PROMPT = (
    "Delegate this to subagents — do NOT do it yourself directly. "
    "Use your subagent orchestration capability to run two subagents in parallel: "
    "one named 'poet' that writes a single two-line poem about the ocean, and one "
    "named 'calculator' that computes 17 * 23 and states the result. "
    "Then combine both results into one short final answer. "
    "Do not read or write any files; this is purely a text task."
)
