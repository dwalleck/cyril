...
roots = [Path(p) for p in sys.argv[1:]] or [
 Path('/home/dwalleck/.local/share/kiro-research/kas-carves/2.21.1/2.21.0/tree'),
 Path('/home/dwalleck/.local/share/kiro-research/kas-carves/2.21.1/2.21.1/tree'),
]
out = Path('experiments/conductor-spike/static-2.21.1/static-kas-surface.json')
