#!/usr/bin/env python3
"""Paired launcher-path workflow capture/artifact probe for the 2.22.0 audit (KAS 0.58.7 -> 0.63.3 -> 0.66.0).
...
try:
    iid = req("initialize", {"protocolVersion": 1, "clientInfo": {"name": "cyril-2.22.0-workflow-audit", "version": "2.22.0"}, "clientCapabilities": {"fs": {"readTextFile": True, "writeTextFile": True}, "terminal": True}})
    init = pump(iid, 90) or {}
