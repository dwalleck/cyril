...
consecutive pair. Writes experiments/conductor-spike/static-2.22.0/static-kas-surface.json.
"""
import hashlib, json, re, sys
from pathlib import Path

roots = [Path(p) for p in sys.argv[1:]]
out = Path('experiments/conductor-spike/static-2.22.0/static-kas-surface.json')
