...
paths = [Path(p) for p in sys.argv[1:]] or [
 Path('/home/dwalleck/.local/share/kiro-research/kas-carves/2.21.2/2.21.1/tree/node_modules/@kiro/agent/dist/server/acp-server.js'),
 Path('/home/dwalleck/.local/share/kiro-research/kas-carves/2.21.2/2.21.2/tree/node_modules/@kiro/agent/dist/server/acp-server.js'),
]
out = Path('experiments/conductor-spike/static-2.21.2/static-kas-identifiers-delta.json')
