...
Measured checkpoints (APlan): archive44bcf1ec to core62437d73 was 2,102 changed lines; core62437d73 to reviewera1ac53c7 was 3,705. APython's core7477df72 measured 2,170 lines. The final evidence-qualified coreb793ac9e is 2,108 insertions + 90 deletions = 2,198 lines across 37 files. The reviewer with compact repair records measures 3,814 insertions + 1 deletion = 3,815 lines across 33 files, leaving 185 lines beneath the 4,000-line cap. These are distinct revision/snapshot measurements, not cumulative edit churn. Executable source remains that checked by CI34102117724 at a8577505.

Final native partition amendment (686d509d, 13:08 UTC): the successful captures alone push the reviewer delta to 4,207 lines before provenance updates, so archive PR #117 now owns all six final snapshot files (`review-native/native-acceptance.json`, `native-{A,B}.{stdout,stderr}.txt`, `auth-preflight.json`). Their source revision is explicit; historical captures remain unchanged. Project 3,981 archive lines plus 19 lines of final immutable-evidence margin; core remains 2,198; reviewer projects at most 3,800 plus 200 margin. No executable or model-policy change is involved. Merge archive into core and core into reviewer before publishing, then measure each actual base/head delta; the earlier 3,815 measurement does not cover the new captures.

Final measured native partition: main2e56ed60→archive51f13f45 is 3,981 additions across 58 files; archive51f13f45→core1d7774f1 is 2,108 additions + 90 deletions = 2,198 across 37 files; core1d7774f1→reviewerb1a92019 is 3,699 additions + 1 deletion = 3,700 across 28 files. This two-line record brings the final reviewer delta to 3,702 (298 margin). All six final snapshots are inherited unchanged through #117→#118→#116; no capture is charged again to the reviewer diff. Only eleven Markdown/JSON/text evidence paths differ from CI a8577505; application, tests, build configuration and oracle sources are unchanged.
