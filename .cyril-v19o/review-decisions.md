...
`module-shape-net-blind-outside-the-allowed-regions`. The oracle is now invoked
from `mutations.sh` at all — previously the gate's `PASS C8` was never
falsified by the mutation set.
